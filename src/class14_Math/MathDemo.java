 ...
 * 		public static double random()：随机数(0.0,1.0)包括左边，不包括右边
...
public class MathDemo {
	public static void main(String[] args) {
		// public static final double PI 求圆面积
		System.out.println("PI：" + Math.PI);
		// public static final double E自然对数
		...
		// public static int round(float a) ：四舍五入(结果强制转换为 int 类型)
		System.out.println("round：" + Math.round(12.34f));
		System.out.println("round：" + Math.round(12.56f));
		System.out.println("--------------------");

		// public static int round(double a) ：四舍五入(结果强制转换为 long 类型)
